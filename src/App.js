...
function App() {
  ...
  return (
    <>
      <H2 label="ITE 233 P2 INDIVIDUAL ACTIVITY" />
      <hr />
      <div className="container">
        <div className="grid">
          <Image src="/saologo.jpg" width={100} height={100} variant="circular" />
          <Image src="/cite.png" width={100} height={100} variant="circular" />
          <Image src="/asuna.jpg" width={200} height={200} variant="rounded" />
          <Image src="/kirito.jpg" width={200} height={200} variant="rounded" />
        </div>
      </div>
      <div className="container">
